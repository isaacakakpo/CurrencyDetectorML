...
import kotlinx.android.synthetic.main.activity_get_exchange_rates.*
import kotlinx.coroutines.launch


class GetExchangeRates : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_get_exchange_rates)
        ...
        ButtonContinue.setOnClickListener {
            ...
            launch {
                AppDatabase(this@GetExchangeRates).getRatesDao().insertRates(rates)
